...
const AboutPage = () =>{
    return(
        <div className="back-page">
          ...
          <p> Our vision is to empowerd students with critical thinking skills, a global perspective, and a strong sense of social responsibility. We aim to nurture individuals who are not only successful in their careers but also contributing members of society.</p>
